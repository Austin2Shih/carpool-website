...
export default function Test() {
    ...
    return (
        <div className={styles.container}>
            <iframe width="600" height="450" frameborder="0" style="border:0" src={"https://www.google.com/maps/embed/v1/directions?key=AIzaSyDIGTev3FnEsggSrZBojc214LfSLpMDxjA&origin=Oslo+Norway&destination=Telemark+Norway&avoid=tolls|highways"} allowfullscreen></iframe>
        </div>
    )
}